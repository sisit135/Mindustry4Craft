...
public class BatteryBlock extends Mindustry4craftModElements.ModElement {
	@ObjectHolder("mindustry4craft:battery")
	public static final Block block = null;
	@ObjectHolder("mindustry4craft:battery")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BatteryBlock(Mindustry4craftModElements instance) {
		super(instance, 24);
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Store FE Energy"));
		}
