...
public class LeadItemItem extends Mindustry4craftModElements.ModElement {
	@ObjectHolder("mindustry4craft:lead_item")
	public static final Item block = null;
	public LeadItemItem(Mindustry4craftModElements instance) {
		super(instance, 2);
	}
