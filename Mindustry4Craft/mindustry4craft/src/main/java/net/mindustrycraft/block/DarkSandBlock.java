...
public class DarkSandBlock extends Mindustry4craftModElements.ModElement {
	@ObjectHolder("mindustry4craft:dark_sand")
	public static final Block block = null;
	public DarkSandBlock(Mindustry4craftModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Mindustry dark sand."));
		}
