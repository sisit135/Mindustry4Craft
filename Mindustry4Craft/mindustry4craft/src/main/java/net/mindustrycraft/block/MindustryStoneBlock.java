...
public class MindustryStoneBlock extends Mindustry4craftModElements.ModElement {
	@ObjectHolder("mindustry4craft:mindustry_stone")
	public static final Block block = null;
	public MindustryStoneBlock(Mindustry4craftModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mindustry_stone");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Stone"));
			list.add(new StringTextComponent("but from Mindustry."));
		}
