...
public class GraphiteItemItem extends Mindustry4craftModElements.ModElement {
	@ObjectHolder("mindustry4craft:graphite_item")
	public static final Item block = null;
	public GraphiteItemItem(Mindustry4craftModElements instance) {
		super(instance, 4);
	}
